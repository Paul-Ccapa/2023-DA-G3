## Archivo: ventaPasajes.py 
## Fecha: 01/11/2023 
## Descripción: Aplicación de venta de pasajes aéreos. 
from tkinter import *
...
class Aplicacion():
  def __init__(self):
    self.raiz = Tk()
    self.raiz.title("Pasajes Aéreos")
    ...
    self.clase1 = ttk.Radiobutton(self.raiz, text='Adulto',variable=self.clase, value='t')
    self.clase2 = ttk.Radiobutton(self.raiz, text='Menores de edad',variable=self.clase, value='p')
    self.clase3 = ttk.Radiobutton(self.raiz, text='Infantes',variable=self.clase, value='l')
    ...
    self.etiq5 = ttk.Label(self.raiz, text="A Pagar (soles):")
  ...
  # Función para validar datos y calcular importe a pagar
    ...
    if self.destino1.get() == self.origen1.get():
      self.total.set("¡Error, misma ciudad de ida y vuelta!")
    if dia11 > dia22 :
      self.total.set("Error, aún no hacemos viajes al pasado!")
  ...
  def fechas(self):
    ...
    self.autof_dia1 = StringVar(value='01/11/2023')
    self.autof_dia2 = StringVar(value='30/11/2023')
    self.etiq1 = ttk.Label(self.raiz2,text="Fecha de ida:")
    self.fecha1 = ttk.Entry(self.raiz2, textvariable=self.autof_dia1,width=10)
    self.etiq2 = ttk.Label(self.raiz2,text="Fecha de vuelta:")
  ...
  def origen(self):
    ...
    self.or1 = ttk.Radiobutton(self.raiz3, text='Munich',variable=self.origen1, value='t')
    self.or2 = ttk.Radiobutton(self.raiz3, text='Lima',variable=self.origen1, value='l')
    self.or3 = ttk.Radiobutton(self.raiz3, text='Arequipa',variable=self.origen1, value='r')
    self.or4 = ttk.Radiobutton(self.raiz3, text='Paris',variable=self.origen1, value='s')
    self.or5 = ttk.Radiobutton(self.raiz3, text='La Plata',variable=self.origen1, value='p')
  ...
  def destino(self):
    ...
    self.de1 = ttk.Radiobutton(self.raiz4, text='Munich',variable=self.destino1, value='t')
    self.de2 = ttk.Radiobutton(self.raiz4, text='Lima',variable=self.destino1, value='l')
    self.de3 = ttk.Radiobutton(self.raiz4, text='Arequipa',variable=self.destino1, value='r')
    self.de4 = ttk.Radiobutton(self.raiz4, text='Paris',variable=self.destino1, value='s')
    self.de5 = ttk.Radiobutton(self.raiz4, text='La Plata',variable=self.destino1, value='p')
